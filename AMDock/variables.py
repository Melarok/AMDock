...
class Variables:
    def __init__(self):
        ...
        if platform.system() == 'Darwin':
            ...
            self.vina_exec = self.data_dir.joinpath('vina_1.2.7').as_posix()
        ...
        self.reference = "<html><head/><body>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600;'>AutoDock Vina 1.2.7:</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt;'>Trott, O., Olson, A. J. (2010). AutoDock Vina: Improving the speed and accuracy  of docking with a new scoring function, efficient optimization, and multithreading. </span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-style:italic;'>J Comput Chem</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt;'>, 31: 455-461.</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt;'>J. Eberhardt, D. Santos-Martins, A. F. Tillack, and S. Forli. (2021). AutoDock Vina 1.2.0: New Docking Methods, Expanded Force Field, and Python Bindings. </span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-style:italic;'>Journal of Chemical Information and Modeling</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt;'>, 61, 8: 3891–3898.</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600;'>AutoDock 4.2.6:</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt;'>Morris, G. M., Huey, R., Lindstrom, W., Sanner, M. F., Belew, R. K., Goodsell, D. S., Olson, A. J. (2009). Autodock4 and AutoDockTools4: automated docking with selective receptor flexiblity. </span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-style:italic;'>J Comput Chem</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt;'>, 30: 2785-2791.</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600;'>AutoDock4</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600; vertical-align:sub;'>Zn </span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600;'>Force Field:</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt;'>Santos-Martins, D., Forli, S., João Ramos, M., Olson, A. J. (2014). AutoDock4</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; vertical-align:sub;'>Zn</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt;'>: an improved AutoDock force field for small-molecule docking to zinc metalloproteins. </span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-style:italic;'>J Chem Info Model</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt;'>, 54: 2371-2379 (http://dx.doi.org/10.1021/ci500209e)</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600;'>AutoLigand:</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt;'>Harris, R., Olson, A., Goodsell, D. (2008). Automated prediction of ligand-binding sites in proteins. </span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-style:italic;'>Proteins</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt;'>, 70: 1505-1517</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600;'>Open Babel 3.1.1:</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt;'>O'Boyle, N. M., Banck, M., James, C. A., Morley, C., Vandermeersch, T., Hutchison, G. R. (2011). Open Babel: An open chemical toolbox. </span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-style:italic;'>J Cheminf</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt;'>, 3: 33</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600;'>PDB2PQR 3.6.1:</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt;'>Dolinsky, T. J., Nielsen, J. E., McCammon, J. A., Baker, N. A. (2004). PDB2PQR: an automated pipeline for the setup of Poisson-Boltzmann electrostatics calculations. </span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-style:italic;'>Nucleic Acids Res</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt;'>, 32: W665-7 (http://dx.doi.org/10.1093/nar/gkh381)</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600;'>Optimal Box Size 1.1:</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt;'>Feinstein, W. P., Brylinski, M. (2015). Calculating an optimal box size for ligand docking and virtual screening against experimental and predicted binding pockets. </span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt; font-style:italic;'>J Cheminf</span>"\
"<span style='font-family:Times New Roman,serif; font-size:10pt;'>, 7: 18</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt; font-weight:600;'>PyMOL 3.1.0:</span></p>"\
"<p><span style='font-family:Times New Roman,serif; font-size:10pt;'>The PyMOL Molecular Graphics System, Version 3.1.0 Schrödinger, LLC. </span></p>"\
"</body></html>"
